...
public class ElasticsearchApplicationTests {
    ...
    public void insertTest() {
        ...
        list.add(Person.builder().age(11).birthday(new Date()).country("CN").id(1L).name("222哈哈").remark("test122").build());
        list.add(Person.builder().age(22).birthday(new Date()).country("US").id(2L).name("222hiahia").remark("test222").build());
        list.add(Person.builder().age(33).birthday(new Date()).country("ID").id(3L).name("222呵呵").remark("test3222").build());
